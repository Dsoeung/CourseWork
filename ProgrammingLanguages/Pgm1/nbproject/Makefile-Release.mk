...
${OBJECTDIR}/cs3723p1.o: cs3723p1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cs3723p1.o cs3723p1.c

${OBJECTDIR}/cs3723p1Driver.o: cs3723p1Driver.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cs3723p1Driver.o cs3723p1Driver.c

${OBJECTDIR}/og/hashApi.o: og/hashApi.cpp
	${MKDIR} -p ${OBJECTDIR}/og
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/og/hashApi.o og/hashApi.cpp

${OBJECTDIR}/serverudp.o: serverudp.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/serverudp.o serverudp.c
